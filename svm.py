...
def predict(data):
    global scaler, keys_encoded, time_on_press, time_on_release, hold_time, time_between_keys, svm_classifier, max_keys_length, max_time_length
    ...
    # Make prediction
    predicted_label = svm_classifier.predict(normalized_feature)
